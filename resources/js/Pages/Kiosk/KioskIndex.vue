...
<template>
    <KioskLayout :activeSessions="rentalOrders.filter(o => o.status === 'active')">
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="p-6 bg-white rounded-lg shadow-lg">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        <div v-for="order in rentalOrders" :key="order.id"
                            ...
                            <div class="p-6">
                                ...
                                <div class="mt-4 space-y-3">
                                    <div class="flex items-center text-sm text-gray-600">
                                        <svg class="mr-2 w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                ...
                                <div class="mt-6">
                                    <button @click="startSession(order)" :disabled="order.status == 'active'"
        ...
        <Modal v-model="pinModal" :closeable="true">
            <div class="p-6">
                ...
                <div class="mt-4">
                    <input type="password" v-model="pinInput" maxlength="4"
                        ...
                        placeholder="****" @keyup.enter="verifyPin" />
