            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 flex justify-between items-start">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            Created on {{ new Date(rentalOrder.created_at).toLocaleDateString() }}
                        </p>
                    </div>
                    <div class="flex space-x-3">
                        <Link
                            :href="route('internal.rental-orders.edit', rentalOrder.id)"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <span
                            :class="[getStatusColor(rentalOrder.status), 'px-3 py-1 rounded-full text-sm font-semibold']"
                        >
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <div class="space-y-2">
                            <p class="text-sm font-medium text-gray-900">{{ rentalOrder.user.name }}</p>
                            <p class="text-sm text-gray-600">{{ rentalOrder.user.email }}</p>
                            <p v-if="rentalOrder.user.profile?.phone" class="text-sm text-gray-600">
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <div class="space-y-2">
                            <p class="text-sm font-medium text-gray-900">
                                {{ rentalOrder.vehicle.brand }} {{ rentalOrder.vehicle.model }}
                            </p>
                            <p class="text-sm text-gray-600">Plate: {{ rentalOrder.vehicle.plate_no }}</p>
                            <p class="text-sm font-semibold text-red-600">
                                ₱{{ rentalOrder.vehicle.rental_rate.toLocaleString() }}/day
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <h2 class="text-lg font-medium text-gray-900">Rental Period</h2>
                        </div>
                        <div class="space-y-2">
                            <p class="text-sm text-gray-600">
                                Start: {{ new Date(rentalOrder.start_date).toLocaleDateString() }}
                            </p>
                            <p class="text-sm text-gray-600">
                                End: {{ new Date(rentalOrder.end_date).toLocaleDateString() }}
                            </p>
                            <p class="text-sm font-medium text-gray-900">
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm text-gray-900">₱{{ rentalOrder.vehicle.rental_rate.toLocaleString() }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm text-gray-600">Duration</span>
                                <span class="text-sm text-gray-900">{{ calculateDuration() }} days</span>
                            </div>
                            <div class="flex justify-between pt-2 border-t">
                                <span class="text-sm font-medium text-gray-900">Total Amount</span>
                                <span class="text-sm font-bold text-red-600">₱{{ rentalOrder.total_amount.toLocaleString() }}</span>
                            </div>
                        </div>
                    </div>
