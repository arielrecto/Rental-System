...
const submit = () => {
    router.post(route('internal.rental-orders.store'), form.value, {
        onSuccess: () => {
            form.value = {
                user_id: '',
                vehicle_id: '',
...
<template>
    <InternalLayout>
        <Head title="Create Rental Order" />

        <div class="py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-6">
                    <h1 class="text-2xl font-semibold text-gray-900">Create Rental Order</h1>
                    <p class="mt-1 text-sm text-gray-600">Create a new rental order</p>
                </div>
