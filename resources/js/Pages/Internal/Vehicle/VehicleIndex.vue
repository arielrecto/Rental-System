...
const submitEdit = () => {
    router.post(route('internal.vehicles.update', editForm.value.id), {
        ...editForm.value,
        _method: 'PUT'
    }, {
        forceFormData: true,
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 flex justify-between items-center">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Manage your vehicle inventory</p>
                    </div>
                ...
                <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    >
                        <div class="aspect-w-16 aspect-h-9">
                            <img
                                :src="vehicle?.image?.file_path || '/images/placeholder-vehicle.jpg'"
                        ...
                        <div class="p-4">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">{{ vehicle.plate_number }}</p>
                                </div>
                                <span
                                    class="px-2 py-1 text-xs font-semibold rounded-full"
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                <p class="text-lg font-bold text-red-600">
                                    ₱{{ vehicle.rental_rate.toLocaleString() }}/day
                                </p>
                                <Link
                                    :href="route('internal.vehicles.edit', vehicle.id)"
            ...
            <form @submit.prevent="submitEdit" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="flex-shrink-0">
                                <div v-if="imagePreview" class="relative w-40 h-40">
                                    ...
                                    <button
                                        type="button"
                                        @click="imagePreview = null; editForm.image = null"
                        ...
                        <div v-if="editErrors.image" class="mt-1 text-sm text-red-600">
                            {{ editErrors.image }}
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            >
                            <div v-if="editErrors.brand" class="mt-1 text-sm text-red-600">
                                {{ editErrors.brand }}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500"
                            >
                            <div v-if="editErrors.model" class="mt-1 text-sm text-red-600">
                                {{ editErrors.model }}
                            </div>
                        </div>
